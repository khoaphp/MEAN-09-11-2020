...
mongoose.connect('mongodb+srv://khoapham:Tch4sFMATHUIbSAh@cluster0.zqn70.mongodb.net/Covid4?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if(err){
