...
mongoose.connect('mongodb+srv://khoapham:Gxh3Uy8zflBlL3Xg@cluster0.aefj6.mongodb.net/Covid?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if(err){
